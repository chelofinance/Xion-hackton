  ...
  return (
    <Main className="Padding_page Font_body_md space-y-page_gap">
      ...
      <ul className="list-disc list-outside pl-4">
        ...
        <li>
          Chelo does not collect and store personal data, such as first name, last name, street address, date of birth, email
        ...
        <li>
          Chelo collects non-identifiable data, such as public on-chain data, and limited off-chain data like device type, browser
        ...
        <li>
          Chelo continues to explore methods to further protect consumers&apos; privacy, such as opt-out prompts, migrating to
