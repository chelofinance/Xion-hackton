...
const RaisingVault: NextPage = () => {
  ...
  const formattedCompactPriceUSD = NFT_DETAIL.priceUSD >= 1000 ? ` (${formatUSD(NFT_DETAIL.priceUSD, { compact: true, semiequate: true })})` : '';
            ...
            <div className="flex items-stretch gap-x-14">
              ...
              <div className="grow shrink space-y-4">
                ...
                <Card color="primary" className="flex items-stretch justify-between gap-x-4 p-4">
                  ...
                  <div className="flex flex-col gap-y-2 items-end">
                    <CoinAmount size="xl" color="on_primary" symbol={TokenSymbols.INJ} formattedAmount={formatNumber(maxDepositAmount)} />
